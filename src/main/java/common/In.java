...
public final class In {
	...
	/**
	 * Initializes an input stream from a class path resource (file loaded from the classpath).
	 * Unqualified resource names will be relative to the package in which the passed in class
	 * belongs.
	 *
	 * @param clazz The class from which the relative resource will be loaded.
	 * @param resourceName The name of the class path resource.
	 */
	public In(Class<?> clazz, String resourceName) {
		if (clazz == null) {
		...
		scanner = new Scanner(new BufferedInputStream(in), CHARSET_NAME);
		scanner.useLocale(LOCALE);
	}
